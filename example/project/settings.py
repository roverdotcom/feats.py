...
import os
import feats
from feats.storage import Memory as FeatsMemoryStorage
...
SECRET_KEY = '_33@b9x)#e1mw0agz8(w74^-ry5tgtnefmwjf^_w+cxfltp3%m'
...
FEATS = feats.App(storage=FeatsMemoryStorage())
